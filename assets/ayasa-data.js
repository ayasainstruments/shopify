...
const ARTISTS = {
  "Malte Marten": {
    ...
    clips: [
      ...
      { name: "D Aegean 20", mode: "D Lydian · extended", handle: "d-aegean-20-ember-steel", file: AYASA_ASSET("malte-marten-d-aegean-20-2.mp4") + "?v=3d374d6e" },
      ...
      { name: "F#2 Nordlys 16", mode: "F# Lydian hexatonic · deep F#2 ding", handle: "fis2-nordlys-16-ember-steel", file: AYASA_ASSET("malte-marten-fis2-nordlys-16-1.mp4") + "?v=3bb32544" },
    ...
    plays: [
      ...
      { name: "D Ashakiran 19", mode: "Extended major · “Ray of Hope”", handle: "d-ashakiran-19-ember-steel-spotted",
        videos: [AYASA_ASSET("malte-marten-d-ashakiran-19-2.mp4") + "?v=0ae4ecd9", AYASA_ASSET("malte-marten-d-ashakiran-19-3.mp4") + "?v=60d29ded", AYASA_ASSET("malte-marten-d-ashakiran-19-4.mp4") + "?v=a9a9a4ff"] },
      ...
      { name: "D Aegean 20", mode: "D Lydian · extended", handle: "d-aegean-20-ember-steel",
        videos: [AYASA_ASSET("malte-marten-d-aegean-20-1.mp4") + "?v=af4d4b0e", AYASA_ASSET("malte-marten-d-aegean-20-2.mp4") + "?v=3d374d6e"] },
      ...
      { name: "F#2 Nordlys 16", mode: "F# Lydian hexatonic · deep F#2 ding", handle: "fis2-nordlys-16-ember-steel",
        videos: [AYASA_ASSET("malte-marten-fis2-nordlys-16-1.mp4") + "?v=3bb32544", AYASA_ASSET("malte-marten-fis2-nordlys-16-2.mp4") + "?v=8a8f1b5e", AYASA_ASSET("malte-marten-fis2-nordlys-16-3.mp4") + "?v=186dbd40", AYASA_ASSET("malte-marten-fis2-nordlys-16-4.mp4") + "?v=eed063fb"] },
...
const MODELS = [
  ...
  },
  {
    ...
    videos: [
      ...
      { artist: "Malte Marten", file: AYASA_ASSET("malte-marten-fis2-nordlys-16-1.mp4") + "?v=3bb32544" }
    ]
  },
